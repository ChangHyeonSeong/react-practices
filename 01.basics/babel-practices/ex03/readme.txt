...
2. 객체분해-파라미터 플러그인(@babel/plugin-transform-paramters)
3. 템플릿 문자열 변환 플러그인(@babel/plugin-transform-template-literals)
4. for..of 변환 플러그인(@babel/plugin-transform-for-of)

5. 모두 적용해보기
$ npm i -D @babel/Plugin-transform-block-scoping @babel/plugin-transform-paramters @babel/plugin-transform-template-literals @babel/plugin-transform-for-of
$ npx 